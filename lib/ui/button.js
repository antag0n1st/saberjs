(function (window, undefined) {
    ...
    function Button(text, style, type, properties) {
        this.initialize(text, style, type, properties);
    }
    ...
    Button.prototype.initialize = function (text, style, type, properties) {
        ...
        this.properties = properties || {
            backgroundColorNormal: '#23c296',
            backgroundColorDown: '#19a881',
            backgroundColorHover: '#30c9a0',
        ...
        this.type = (type === undefined || type === null) ? Button.TYPE_NINE_SLICE : type;
        ...
        if (this.type === Button.TYPE_NORMAL) {
            ...
            this.background.setSize(style.width || 200, style.height || 80);
            this.addChild(this.background);
