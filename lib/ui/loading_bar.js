...
//}
    ...
    LoadingBar.prototype.initialize = function (options) {
        ...
        this.animationSpeed = (options.animationSpeed !== undefined) ? options.animationSpeed : 0.2;
        ...
        if (this.showPercent) {
            ...
            this.percentLabel.style.fontSize = Math.round(this.foregroundHeight * 0.7);
            this.percentLabel.style.fontFamily = 'Impact,Arial Black';
        ...
        this.duration = 0; // the animation duration
    ...
    LoadingBar.prototype.drawMask = function (percent) {
        ...
        if (mask) {
            ...
            mask.drawRect(x, y, this.foregroundWidth * this.percentage, this.foregroundHeight);
            mask.endFill();
        }
