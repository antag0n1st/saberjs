(function (window, undefined) {
    ...
    NineSlice.prototype.buildBackground = function () {
        ...
        _top = Math.clamp(_top, -100, 100);
        _right = Math.clamp(_right, -100, 100);
        _bottom = Math.clamp(_bottom, -100, 100);
        _left = Math.clamp(_left, -100, 100);
    ...
    NineSlice.prototype.onUpdate = function (dt) {
