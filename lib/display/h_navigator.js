(function (window, undefined) {
    ...
    HNavigator.prototype.add = function (screen, duration, animationType, transitionCallback, transitionScreen) {
        ...
        var anim = (typeof (animationType) === 'undefined') ? HNavigator.ANIMATION_TYPE_FADEOUT : animationType;
    ...
    HNavigator.prototype.animationSlide = function (duration, direction, callback) {
        ...
        var tween_old = new TweenMoveTo(this.currentScreen, new Vector(-this.app.width, 0), null, duration);
        var tween_new = new TweenMoveTo(this.newScreen, new Vector(0, 0), null, duration, function () {
            callback.call(app.navigator);
        });
    ...
    HNavigator.prototype.animationSlideOver = function (duration, direction, callback) {
        ...
        this.newScreen.position.set(this.app.width, 0);
        var tween_old = new TweenMoveTo(this.currentScreen, new Vector(0, 0), null, 0);
        var tween_new = new TweenMoveTo(this.newScreen, new Vector(0, 0), null, duration, function () {
            callback.call(app.navigator);
        });
    ...
    HNavigator.prototype.goBack = function (animationType, duration, transitionCallback) {
    ...
    HNavigator.prototype.goToRoot = function (animationType, duration, transitionCallback) {
    ...
    HNavigator.prototype.goToIndex = function (index, animationType, duration, transitionCallback) {
    ...
    HNavigator.prototype.update = function (dt) {
        ...
        if (this.currentScreen !== null && !this.currentScreen.isPaused) {
            ...
            //  log(this.currentScreen);
            //  log(this.currentScreen.children.length);
