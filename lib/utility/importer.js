(function (window, undefined) {
    ...
    Importer.prototype.unwrapObject = function (data, parent) {
        ...
        if (data.properties && data.properties.isCustomSensor) {
            ...
            var style = {};
            this.applyValues(style, _label_style_defaults);

            if (data.properties) {
                var styledProperties = Styles.labelStyles[data.properties.styleName];
                if (styledProperties) {

                    this.applyValues(style, styledProperties, data.style || {});
                } else {
            ...
            var props = {};
            this.applyValues(props, _button_properties_defaults);
            ...
            if (data.properties) {
                ...
                if (data.properties.styleName && Styles.buttonStyles[data.properties.styleName]) {
                    var styledProperties = Styles.buttonStyles[data.properties.styleName];
                    this.applyValues(props, styledProperties.properties,data.properties);
                    this.applyValues(style, styledProperties.style , data.style || {});
                }

                this.applyValues(props, data.properties || {});
            }
            ...
            var props = {};
            this.applyValues(props, _input_properties_defaults);
            this.applyValues(props, data.properties || {});
            ...
            var props = {};
            this.applyValues(props, _nineslice_properties_defaults);
            this.applyValues(props, data.properties || {});
            ...
            var props = {};
            this.applyValues(props, _tilingsprite_properties_defaults);
            this.applyValues(props, data.properties || {});
    ...
    Importer.prototype.applyValues = function (object, values, compare) {
