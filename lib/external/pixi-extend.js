...
PIXI.DisplayObject.prototype.fitTo = function (fitWidth, fitHeight, scaleUp) {
        ...
        if (myWidth > myHeight) { //its a wide object

            if (!scaleUp && myWidth < fitWidth) {
                if(!scaleUp && myHeight > fitHeight){
                    this.scale.set(fitHeight / myHeight);
                }
                return;
            }

            this.scale.set(fitWidth / myWidth);
