...
PIXI.DisplayObject.prototype.tag = 0;
...
PIXI.DisplayObject.prototype.updateSensor = function () {
    ...
    this.sensor = new SAT.Box(new SAT.V(this.x, this.y), this._width * sx, this._height * sy).toPolygon();

    // since we are creating a new sensor , 
    // lets just update it to its values  ,correct translation and rotation
...
PIXI.DisplayObject.prototype.setSensorSize = function (width, height) {
    ...
    this._width = width;
    this._height = height;
    //this.sensor = new SAT.Box(new SAT.V(this.x, this.y), width, height).toPolygon();
    this.updateSensor();
};

PIXI.DisplayObject.prototype.adjustTranslation = function () {
...
PIXI.DisplayObject.prototype.adjustRotation = function () {
...
PIXI.DisplayObject.prototype.update = function (dt) {
